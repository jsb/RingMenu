...
function RingMenuSettings_SetupSettingsFrame()
    local settingsFrameConfig = {
        ...
        rows = {
            ...
            { name = "Radius", text = "Radius", widget = "slider", min = 0, max = 300, labelSuffix = " px", valueStep = 5, updateFunc = RingMenuSettings_Radius_OnUpdate },
            { name = "Angle", text = "Angle", widget = "slider", min = 0, max = 360, labelSuffix = "°", valueStep = 15, updateFunc = RingMenuSettings_Angle_OnUpdate },
